...
public class ProcessListPanel extends JPanel {
    ...
    public ProcessListPanel(BiConsumer<String, CommandMode> consumer) {
        ...
        lblProcessCount = new JLabel(App.getContext().getBundle().getString("total_processes") + " 0");
        ...
        b1.add(new JLabel(App.getContext().getBundle().getString("processes")));
        ...
        JButton btnFilter = new JButton(App.getContext().getBundle().getString("filter"));
        ...
        JButton btnClearFilter = new JButton(App.getContext().getBundle().getString("clear"));
        ...
        JMenuItem mKill = new JMenuItem(App.getContext().getBundle().getString("kill"));
        JMenuItem mKillAsRoot = new JMenuItem(App.getContext().getBundle().getString("kill_sudo"));
        ...
        JMenuItem mPrio = new JMenuItem(App.getContext().getBundle().getString("change_priority"));
        JMenuItem mPrioAsRoot = new JMenuItem(App.getContext().getBundle().getString("change_priority_sudo"));
        prioPopup.add(mPrio);
        ...
        btnCopyArgs = new JButton(App.getContext().getBundle().getString("copy_command"));
        ...
        btnKill = new JButton(App.getContext().getBundle().getString("kill_process"));
    ...
    public void setProcessList(List<ProcessTableEntry> list) {
        lblProcessCount.setText(App.getContext().getBundle().getString("total_processes") + " " + list.size()
                + ", " + App.getContext().getBundle().getString("last_updated") + " " + LocalDateTime.now().format(
