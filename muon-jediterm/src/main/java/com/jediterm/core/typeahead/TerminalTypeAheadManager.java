...
public class TerminalTypeAheadManager {
  ...
  public static class TypeAheadEvent {
    ...
    public static List<TypeAheadEvent> fromByteArray(byte[] byteArray) {
    ...
    public static List<TypeAheadEvent> fromString(String string) {
      if (string.isEmpty()) {
        return Collections.emptyList();
      }
      ...
      ArrayList<TypeAheadEvent> events = new ArrayList<>();
  ...
  private @NotNull List<TypeAheadPrediction> getVisiblePredictions() {
